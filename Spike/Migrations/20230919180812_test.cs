...
namespace Spike.Migrations
{
    ...
    public partial class test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(
                name: "FK_AuthorV1DocumentV1_DocumentV1_DocumentsV1Id",
                table: "AuthorV1DocumentV1");
            ...
            migrationBuilder.AlterTable(
                name: "DocumentsV1")
                .OldAnnotation("SqlServer:IsTemporal", true)
                .OldAnnotation("SqlServer:TemporalHistoryTableName", "DocumentHistoricV1")
                .OldAnnotation("SqlServer:TemporalHistoryTableSchema", null)
                .OldAnnotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                .OldAnnotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorsHistoricV1", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DocumentsHistoricV1",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentsHistoricV1", x => x.Id);
                });
